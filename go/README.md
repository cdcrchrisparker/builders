...
**The build if you want specify a specific UID/GID (here I use '2000')**
...
Now that you have a convenient alias, you can run "go" commands as if Golang is installed locally.  For example, to initialize a new project:
